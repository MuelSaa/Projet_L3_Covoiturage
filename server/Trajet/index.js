...
exports.findTrajetDepart = (req, res) => {
    ...
    departLat = parseInt(req.query.departLat);
    departLon = parseInt(req.query.departLon);
    arriverLat = parseInt(req.query.arriverLat);
    arriverLon = parseInt(req.query.arriverLon);
