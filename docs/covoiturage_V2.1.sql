...
--
-- Name: covoiturage; Type: DATABASE; Schema: -; Owner: covoiturage_user
--

CREATE DATABASE covoiturage WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'en_US.UTF8';


ALTER DATABASE covoiturage OWNER TO covoiturage_user;
...
--
-- Name: covoiturage; Type: DATABASE PROPERTIES; Schema: -; Owner: covoiturage_user
--

ALTER DATABASE covoiturage SET "TimeZone" TO 'utc';
